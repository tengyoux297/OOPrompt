    ...
    <>
       ...
       <aside className="w-full h-full bg-white flex flex-col">
          <div className="flex flex-col h-full">
                         {/* Objects List */}
             <div className={`flex-1 overflow-y-auto min-h-0 p-2 space-y-1.5 transition-all duration-300 ${
               ...
               {displayObjects.map((obj) => {
                 ...
                 return (
                   <div
                     key={obj.id}
                     className={`group cursor-pointer transition-all duration-200 hover:shadow-sm border border-gray-200 hover:border-gray-300 px-3 py-2.5 rounded-lg bg-white ${
                       isSelected ? 'ring-2 ring-blue-500 ring-offset-1 border-blue-300 shadow bg-blue-50' : 'hover:bg-gray-50'
                     }`}
                     onClick={() => handleObjectClick(obj.id)}
                   >
                     <div className="flex items-start justify-between">
                       <div className="flex-1 min-w-0 pr-2">
                         <div className="font-semibold text-sm leading-tight text-gray-900 mb-1 break-words line-clamp-2" title={obj.main_task}>
                       ...
                       <div className="flex items-center gap-0.5 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                         ...
                         <button
                           ...
                           className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-all duration-200 border border-transparent hover:border-blue-200"
                         ...
                         <button
                           ...
                           className="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-md transition-all duration-200 border border-transparent hover:border-red-200"
